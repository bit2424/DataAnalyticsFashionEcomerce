...
class price_model():
  ...
  def execute():
    ...
    print(pcolors.OKGREEN + pcolors.UNDERLINE + pcolors.BOLD + "<<<---------------------------- INTERESTING FEATURES ----------------------------\n" + pcolors.ENDC)
    ...
    print(pcolors.OKGREEN + pcolors.UNDERLINE + pcolors.BOLD + "<<<---------------------------- INTERESTING FEATURES AFTER CLEANING ----------------------------\n" + pcolors.ENDC)
    print(df_interesting.info())
    print(pcolors.OKGREEN + pcolors.UNDERLINE + pcolors.BOLD + "   ---------------------------- INTERESTING FEATURES AFTER CLEANING ---------------------------->>>\n\n" + pcolors.ENDC)
    ...
    print(pcolors.OKGREEN + pcolors.UNDERLINE + pcolors.BOLD + "<<<---------------------------- CORRELATION MATRIX ----------------------------\n" + pcolors.ENDC)
    ...
    print(pcolors.OKGREEN + pcolors.UNDERLINE + pcolors.BOLD + "<<<---------------------------- CATEGORIES ONE HOT ENCODING ----------------------------\n" + pcolors.ENDC)
    ...
    *   Elemento de lista: Calculamos el promedio del promedio de las ventas de todos los tag
    ...
    print(pcolors.OKGREEN + pcolors.UNDERLINE + pcolors.BOLD + "<<<---------------------------- RESULTING DATA SET ----------------------------\n" + pcolors.ENDC)
    print(df_interesting.info())
    print(pcolors.OKGREEN + pcolors.UNDERLINE + pcolors.BOLD + "   ---------------------------- RESULTING DATA SET ---------------------------->>>\n\n" + pcolors.ENDC)
    ...
    *   Conjunto de prueba
    ...
    print(pcolors.OKGREEN + pcolors.UNDERLINE + pcolors.BOLD + "<<<---------------------------- MODELS COMPARISON ----------------------------\n" + pcolors.ENDC)
    ...
    for name,model in base_models:
        ...
        print(pcolors.OKCYAN + pcolors.UNDERLINE + pcolors.BOLD + f'{name} cross validation accuracy score:{mean_score} +- {std_dev} (std) min:{min_score},max:{max_score}' + pcolors.ENDC)
    print(pcolors.OKGREEN + pcolors.UNDERLINE + pcolors.BOLD + "   ---------------------------- MODELS COMPARISON ---------------------------->>>\n\n" + pcolors.ENDC)
